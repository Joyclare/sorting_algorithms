...
/**
 * swap_backward - a function that checks backward and swap
 * @val: list
...
/**
 * swap_forward - a function that swaps two nodes left to right position
 * @val: list
 **/
...
/**
 * insertion_sort_list - A function that sorts a double linked list
